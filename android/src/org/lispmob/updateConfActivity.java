	...
	public void createConfFile()
	{
		...
		try {
			...
			defText = new StringBuilder()
						...
						.append("#   router-mode: on  -> LISP routing capabilities enabled: xTR\n")
						.append("#                off -> LISP mobile node\n")
						.append("#      debug: Debug levels [0..3]\n")
						.append("#      map-request-retries: Additional Map-Requests to send per map cache miss\n\n")
						.append("router-mode            = off			#In doubt, keep the default value\n")
						...
						.append("#   address: IPv4 or IPv6 address or FQDN name of the map resolver\n")
						.append("map-resolver        = {\n")
						.append("        "+MR+",\n")
						.append("}\n\n\n")
						...
						.append("#\n")
						.append("#   address: IPv4 or IPv6 address or FQDN name of the DDT root node\n")
						...
						.append("# of them.\n")
						.append("#   address: IPv4 or IPv6 address or FQDN name of the map-server\n")
						...
						.append("#   address: IPv4 or IPv6 address or FQDN name of the Proxy-ETR\n")
						...
						.append("#   address: IPv4 or IPv6 address or FQDN name of the Proxy-ITR\n")
