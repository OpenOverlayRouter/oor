...
EXEC_PATH:=app/build/intermediates/ndkBuild/debug/obj/local
...
LOCAL_SRC_FILES = \
		  ...
		  control/lisp_ddt_mr.c          \
		  control/lisp_ddt_node.c        \
		  control/lisp_ms.c              \
		  control/lisp_rtr.c		 \
		  control/lisp_tr.c		 \
		  control/lisp_xtr.c             \
		  ...
		  liblisp/lisp_mref_mapping.c    \
		  lib/cksum.c                    \
		  lib/ddt_map_cache_entry.c      \
		  lib/generic_list.c             \
		  lib/hmac.c                     \
		  lib/htable_ptrs.c              \
...
LOCAL_CFLAGS += -DVPNAPI
LOCAL_MODULE := oor
LOCAL_MODULE_FILENAME := liboor

include $(BUILD_SHARED_LIBRARY)

OUT_PATH:=${NDK_OUT}/local/$(TARGET_ARCH_ABI)
$(shell cp $(OUT_PATH)/oorexec $(OUT_PATH)/liboorexec.so)
