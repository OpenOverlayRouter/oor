...
#define CMDLINE_PARSER_PACKAGE "oor"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "oor"
#endif
...
struct gengetopt_args_info
{
  ...
  enum enum_debug debug_arg;	/**< @brief Debugging output [0..3].  */
  char * debug_orig;	/**< @brief Debugging output [0..3] original value given at command line.  */
  const char *debug_help; /**< @brief Debugging output [0..3] help description.  */
  ...
  const char *daemonize_help; /**< @brief Daemonize oor help description.  */
  ...
  int oorconfig_mode_counter; /**< @brief Counter for mode oorconfig */
} ;
