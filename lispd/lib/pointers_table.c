...
int
htable_ptrs_timers_add(htable_ptrs_t *ptr_ht, void *key, lmtimer_t *timer)
{
    glist_t *timer_lst;
...
int
htable_ptrs_timers_rm_timer(htable_ptrs_t *ptr_ht, void *key, lmtimer_t *timer)
{
    glist_t *timer_lst;
