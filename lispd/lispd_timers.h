...
#define DDT_MAP_REQUEST_RETRY_TIMER         "DDT_MAP_REQUEST_RETRY_TIMER"
#define DDT_MAP_REQ_RETRY_MS_ACK_TIMER      "DDT_MAP_REQ_RETRY_MS_ACK_TIMER" // We receive ddt ms-ack referral but not Map Reply. Send Map request
